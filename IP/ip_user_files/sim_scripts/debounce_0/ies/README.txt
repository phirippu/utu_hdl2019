...
#
# Generated by export_simulation on Sun Feb 02 23:02:48 EET 2020
#
################################################################################
...
'-reset_run' switch to the './debounce_0.sh' script.

./debounce_0.sh -reset_run
...
./debounce_0.sh -noclean_files

For more information on the script, please type './debounce_0.sh -help'.
