...
#
# Generated by Vivado on Sun Feb 02 23:05:00 EET 2020
# SW Build 2729669 on Thu Dec  5 04:48:12 MST 2019
#
# Copyright 1986-2019 Xilinx, Inc. All Rights Reserved. 
#
# usage: pwm_0.sh [-help]
# usage: pwm_0.sh [-lib_map_path]
# usage: pwm_0.sh [-noclean_files]
# usage: pwm_0.sh [-reset_run]
#
#*********************************************************************************************************
...
# Script info
echo -e "pwm_0.sh - Script generated by export_simulation (Vivado v2019.2.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L secureip -L xpm --snapshot pwm_0 xil_defaultlib.pwm_0 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim pwm_0 -key {Behavioral:sim_1:Functional:pwm_0} -tclbatch cmd.tcl -log simulate.log
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./pwm_0.sh -help\" for more information)\n"
        exit 1
      fi
     copy_setup_file $2
    ;;
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb pwm_0.wdb xsim.dir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./pwm_0.sh -help\" for more information)\n"
    exit 1
  fi
