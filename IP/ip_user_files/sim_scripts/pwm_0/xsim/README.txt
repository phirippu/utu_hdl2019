...
#
# Generated by export_simulation on Sun Feb 02 23:05:00 EET 2020
#
################################################################################
...
'-reset_run' switch to the './pwm_0.sh' script.
...
./pwm_0.sh -noclean_files

For more information on the script, please type './pwm_0.sh -help'.
